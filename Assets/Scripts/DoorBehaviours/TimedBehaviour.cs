...
{
    /// <summary>
    /// Class <c>TimedBehaviour</c> represents a timed door.
    /// </summary>
    public class TimedBehaviour : IDoorBehaviour
    {
        ...
        public void UpdateBehaviour()
        {
            ...
            if (_timer > 0f)
            {
                ...
                _door.uiManager.UpdateTimerText(_timer, true);
            }
            ...
            if (_timer <= 0f)
            {
                ...
                _door.uiManager.UpdateTimerText(0f, false);
            }
        }
        ...
        public void OnTriggerEnter(Collider col)
        {
            ...
            if (_timer <= 0f)
            {
                _door.uiManager.UpdateMessageText("Switch needed", 2f);
            }
        }
